...
Illuminate the future with innovative            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-red-500">
              {" "}
      ...
      <Image
          ...
          height={150}
          width={150}
          className="absolute right-55 top-20"
        />
         <Image src="/cliff.webp" alt="cliff" width={300} height={300} /> 
      </div>
